...
> Controlling for infant birth weight, ANCOVA indicated that prenatal sleep quantity (TST) also had a signiﬁcant eﬀect on labor duration ($\text{F}[2,125] = 5.54$, $\text{P} = .005$). [@lee2004, pp. 2044]
...
<p style="font-size: .9rem;color: #5a6570;">$^{\ast}$Adjusted for infant birth weight.</p>
<p style="margin-top: -0.25em; font-size: .9rem;color: #5a6570;">$^{\dagger}$Significantly longer labor than the other 2 groups.</p>
